...
export GITHUB_BASE_URL="https://raw.githubusercontent.com/bexnxx07/pterodactyl-installer"
...
curl -sSL -o /tmp/lib.sh https://raw.githubusercontent.com/bexnxx07/pterodactyl-installer/master/lib/lib.sh
